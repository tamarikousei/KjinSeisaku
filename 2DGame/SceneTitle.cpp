...
namespace
{
	constexpr int kMessageFontSize = 32;    // メッセージの文字サイズ（お好みで調整してください）
	constexpr int kMessageThickness = 6;    // フォントの太さ
	constexpr int kMessageY = 515;          // メッセージのY座標。タイトル画像の少し下になるよう仮置きしています
...
SceneTitle::SceneTitle():
	...
	m_isGameStart(false)
{
	m_handle = LoadGraph("date/titleBg.png");
